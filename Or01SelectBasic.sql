...
SELECT ename, sal "급여", sal+300 "급여인상" FROM emp;
...
select ename "이름" , mgr "부서번호" from emp where mgr=7782;

/*
5. 급여가 2000에서 3000사이에 포함되지 않는 사원의 이름과 급여를 
출력하시오.
*/
