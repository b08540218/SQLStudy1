...
insert into tb_goods VALUES (2, '크포빵'); 
...
create SEQUENCE seq_serial_num
    ...
    minvalue 9  /* 최솟값 : 9 */
    maxvalue 20 /* 최대값 : 20 */
    cycle   /* 최대값 도달시 최솟값부터 재시작 여부 : Yes */
...
문제없이 입력된다.
*/
insert into tb_goods VALUES (seq_serial_num.nextval, '크포빵'); 
...
alter sequence seq_serial_num
    ...
    NOMAXVALUE /* 최대값 사용하지 않음. 즉 표현할 수 있는 최대법위 사용 */
    NOCYCLE /* 사이클 사용하지 않음 */
